...
public class ProductList {
    ...
    public ArrayList<Product> sortDescending()
    {
        ...
        var items= sorter.sortDescending(this.products);
        return items;
    }
    ...
    {
        ProductSort sorter = new ProductSort();
        var items = sorter.sortAscending(this.products);
        return items;
    }
    ...
    {
        ProductSort sorter = new ProductSort();
        var result= sorter.sortDescending(items);
        return  result;
    }
    ...
    {
        ProductSort sorter = new ProductSort();
        var result= sorter.sortAscending(items);
        return  result;
    }
